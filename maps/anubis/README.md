...
![Map callout overview](assets/anubis-callouts.webp)

[Visual/source note](assets/map-overview-source.md)

## Positioning visual

![Anubis route teaching diagram showing Mid and Connector pressure, Water and Canal access, A Main and B Main spacing, Temple isolation, and CT rotations](assets/positioning-overview.svg)
...
![Anubis T-side five-player default showing roles, spawn-based routes, and initial pressure](assets/default-t.svg)
...
![Anubis CT-side five-player default showing roles, hold angles, support, and the first rotation trigger](assets/default-ct.svg)
