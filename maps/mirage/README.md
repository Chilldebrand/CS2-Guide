...
![Mirage route teaching diagram showing Mid pressure against Window and Connector, A Ramp and Palace spacing, B Apartments pressure, CT anchors, and rotation paths](assets/positioning-overview.svg)
...
![Mirage T-side five-player default showing roles, spawn-based routes, and initial pressure](assets/default-t.svg)
...
![Mirage CT-side five-player default showing roles, hold angles, support, and the first rotation trigger](assets/default-ct.svg)
