...
![Nuke T-side five-player default showing roles, spawn-based routes, and initial pressure](assets/default-t.svg)
...
![Nuke CT-side five-player default showing roles, hold angles, support, and the first rotation trigger](assets/default-ct.svg)
